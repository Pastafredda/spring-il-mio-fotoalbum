--fotografie
INSERT INTO fotoalbum_db.fotografie(id, descrizione, titolo, url, visibile)VALUES(1, 'Descrizione bella di foto 1', 'Vulcano', 'https://www.nationalgeographic.it/upload/ngi-image/img-13098-vulcano.png?w=710&h=474', 1);
